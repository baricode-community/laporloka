...
@section('title', 'Edit Laporan - ' . $report->report_number)
...
@section('content')
    ...
    <div class="relative isolate pt-24 pb-20">
        <div class="container mx-auto px-4">
            <nav class="flex mb-8" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    <li class="inline-flex items-center">
                        <a href="{{ route('reports.index') }}" class="inline-flex items-center text-sm font-medium text-gray-500 hover:text-blue-600">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('reports.show', $report->id) }}" class="ml-1 text-sm font-medium text-gray-500 hover:text-blue-600 md:ml-2">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            <svg class="w-6 h-6 text-gray-300" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                            <span class="ml-1 text-sm font-medium text-gray-400 md:ml-2">Edit</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="max-w-4xl mx-auto">
                <livewire:edit-report :report="$report" />
            </div>
        </div>
    </div>
@endsection
